...
dating_boost_cli adapter claude-code install --scope "$DATING_BOOST_INSTALL_SCOPE" --json
dating_boost_cli adapter claude-code doctor --data-dir "$DATING_BOOST_DATA_DIR" --json
