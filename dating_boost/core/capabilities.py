...
_BASE_SUPPORTED_COMMANDS: list[str] = [
    ...
    "feedback record",
    "eval run --suite memory",
    "eval run --suite memory-review",
    "skill doctor",
    "planner update",
    "planner get",
    "planner recommend",
...
def build_capabilities(data_dir: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "memory_capabilities": {
            ...
            "memory_review_report": True,
            "memory_review_acceptance": True,
            "semantic_context_hooks": True,
        },
        "agent_native_capabilities": {
            ...
            "stage_only_audit": True,
            "action_correction_audit": True,
            "automation_session": True,
            "managed_session": True,
            "multi_thread_managed_session": True,
            "managed_session_management_modes": ["conservative", "high-throughput"],
            "managed_session_command": "dating-boost managed-session",
            ...
            "managed_session_resumable_pagination": True,
            "managed_session_serial_work_items": True,
            "managed_session_scope": "user_explicit_session_only",
            "managed_session_background_model": "bounded_user_explicit_session_not_global_daemon",
            ...
            "managed_session_global_background_required": False,
            "managed_session_global_background_reason": "intentional_safety_boundary",
            ...
            "tashuo_host_loop": "tashuo" in host_loop_app_profiles,
            ...
            "repo_computer_use_execution_backend_required": False,
            "computer_use_execution_model": "host_agent_capability_when_available_not_repo_backend",
            "managed_live_send_guidance": managed_live_send_guidance(),
            ...
            "tashuo_gui_launch": "tashuo" in supported_app_profiles,
            ...
            "tashuo_mac_ios_app_managed_smoke_command": "python3 scripts/tashuo_mac_ios_managed_smoke.py",
            ...
            "tashuo_question_gate_send_harness": False,
            "tashuo_question_gate_autonomous_send": False,
            "tashuo_live_send_harness": "tashuo" in supported_app_profiles,
