...
def _build_system_prompt() -> str:
    return (
        ...
        "Avoid survey-style A/B wording in Chinese private chat unless the two options are concrete, natural, "
        "and genuinely useful; do not make an already-confirmed fact one side of a choice. Prefer a single "
        "yes/no-style hypothesis or a light statement when the goal is to test one guess. "
