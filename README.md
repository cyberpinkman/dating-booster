...
| 她说 / TaShuo | profile/chat 观察、问答门槛相关流程、可选托管发送；Apple Silicon Mac 可试验本地 iOS app runtime（当前限 launch/observe/stage，托管 live send 暂停） | macOS iPhone Mirroring；可选 mac-ios-app |
