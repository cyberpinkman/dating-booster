...
class AppProfileContractTests(unittest.TestCase):
    ...
    def test_tashuo_mac_ios_app_stage_and_live_send_are_alternate_runtime_capabilities(self):
        ...
        self.assertIn("prepare_self_profile_page", mac_runtime["supported_stage_actions"])
        self.assertIn("open_self_profile_detail", mac_runtime["supported_stage_actions"])
        self.assertIn("profile_scroll_down", mac_runtime["supported_stage_actions"])
        self.assertIn("profile_scroll_up", mac_runtime["supported_stage_actions"])
        self.assertIn("profile_scroll_to_bottom", mac_runtime["supported_stage_actions"])
